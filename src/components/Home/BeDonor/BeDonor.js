...
const BeDonor = () => {
    return (
        <section className='border-b-2 border-t-2 shadow-xl'>
            <div className='m-12'>
                <h1 className="py-4 text-center text-3xl text-red-700 font-bold">
                    Donate The Blood
                </h1>
                <p className='py-4 px-16 text-justify text-gray-700'>
                ...
                <div className='flex justify-center mt-8'>
                    <button className='py-4 px-16 text-white text-xl font-bold rounded-full bg-red-700 hover:bg-red-300 hover:text-red-700'>
                        <Link to='/beDonor'>
                            Be a Life Saver
                        </Link>
                    </button>
